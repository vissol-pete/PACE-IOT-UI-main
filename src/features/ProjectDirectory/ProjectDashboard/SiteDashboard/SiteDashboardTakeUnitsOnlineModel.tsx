...
export default function SiteDashboardTakeUnitsOnlineModel({
  openSiteDashboardTakeUnitsOnlineModel,
  ...
  const handleClose = () => setOpenSiteDashboardTakeUnitsOnlineModel(false);
  ...
  return (
    <Modal
      open={openSiteDashboardTakeUnitsOnlineModel}
      onClose={handleClose}
    ...
    >
      <Box sx={getModalStyle(isSmallScreen)}>
        <Typography id="modal-modal-title" variant="h6">
          take selected unit(s) online
        </Typography>
        <Box sx={{ marginTop: "20px" }} />
        <Typography id="modal-modal-title" variant="body1">
          This action will enable all PACE AI devices at the selected unit(s).
        </Typography>
        <Box sx={{ marginTop: "20px" }} />
        <Typography id="modal-modal-title" variant="body1">
